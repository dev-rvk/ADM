...
import { ConsumableWritableStream, PushReadableStream, StructDeserializeStream, WritableStream, } from "@yume-chan/stream-extra";
...
export class AdbSubprocessShellProtocol {
    ...
    constructor(socket) {
        ...
        this.#stdin = new WritableStream({
            write: async (chunk) => {
                await ConsumableWritableStream.write(this.#writer, AdbShellProtocolPacket.serialize({
